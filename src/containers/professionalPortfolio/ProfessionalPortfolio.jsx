...
import './whatjk.css';
/*
     <div className="jk__whatjk-feature">
...
const ProfessionalPortfolio = () => {
  return (
    <div className="jk__whatjk section__margin" id="portfolio">
    
    <div className="jk__whatjk-heading">
      <h1 className="gradient__text">Professional Profile</h1>
    </div>
    <div className="jk__whatjk-container">
